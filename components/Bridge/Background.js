  ...
  return (
    <section className="layout full-bleed" data-toc-title="Background" id="section-1">
      ...
      <section className="my-32">
        ...
        <h4 className="font-semibold text-lg text-gray-700 mb-4">Responders of the survey by Pew Research Center say</h4>
        <Scroller>
          <div className="inline-block max-w-full w-[26rem] p-8 bg-white shadow-md rounded-xl">
            <div className="text-gray-900 mb-6 whitespace-normal">
              ...
              <h5 className="font-semibold text-xl">Lack of understanding about data use</h5>
              <p className="text-gray-600">
                They have very little/no understanding about what ___ do/does with the data collected.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="flex flex-col">
                ...
                <data className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-pink-400 to-blue-700">59%</data>
              </div>
              <div className="flex flex-col">
                <h6 className="text-gray-500">Government</h6>
                <data className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-pink-600 to-purple-800">78%</data>
              </div>
            </div>
          </div>
          <div className="inline-block max-w-full w-[26rem] p-8 bg-white shadow-md rounded-xl">
            <div className="text-gray-900 mb-6 whitespace-normal">
              ...
              <p className="text-gray-600">They have very little/no control over the data ____ collect(s)</p>
            </div>

            <div className="grid grid-cols-2 gap-6">
              <div className="flex flex-col">
                <h6 className="text-gray-500">Companies</h6>
                <data className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-pink-600 to-purple-800">81%</data>
              </div>
              <div className="flex flex-col">
                <h6 className="text-gray-500">Government</h6>
                <data className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-pink-600 to-purple-800">84%</data>
              </div>
            </div>
          </div>
          <div className="inline-block max-w-full w-[26rem] p-8 bg-white shadow-md rounded-xl">
            <div className="text-gray-900 mb-6 whitespace-normal">
              ...
              <p className="text-gray-600">
                They are very/somewhat concerned about how ___ use(s) the data collected
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="flex flex-col">
                <h6 className="text-gray-500">Companies</h6>
                <data className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-pink-600 to-purple-800">79%</data>
              </div>
              <div className="flex flex-col">
                <h6 className="text-gray-500">Government</h6>
                <data className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-pink-600 to-purple-800">65%</data>
              </div>
            </div>
          </div>
        </Scroller>
